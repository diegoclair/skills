...
For non-technical users, `confluence-docs update` is enough — no URL to remember. Reply in the user's language with the result, e.g. "Already on the latest version (v0.11.1)" or "Updated from v0.11.0 → v0.11.1".
